...
```
cd existing_repo
git remote add origin https://gitlab.com/chromaway/core/ai-inference-extension.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/chromaway/core/ai-inference-extension/-/settings/integrations)
